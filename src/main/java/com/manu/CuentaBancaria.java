...
boolean consignar(int valor) {
    ...
    System.out.println("Se ha consignado $" + valor + " El nuevo saldo es $" + saldo);
    return true;
    } else {
    System.out.println("valor a consignar mayor que cero");
    return false;
    }
    }
    ...
    CuentaBancaria cuenta = new CuentaBancaria("Manu","Estrada",
    941601099,tipo.AHORROS);
    cuenta.imprimir();
